...
class KDTreeTest extends AnyFlatSpec with Matchers {
  ...
  "The k-d tree" should "work with a large dataset (36 clusters of 100 obs)" in {
    ...
    /*val tree =*/ KDTree.createWithLeavesNumber(matrix, 8, 0, KDTree.cutUsingTileDimensions)
